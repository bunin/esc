...
func Run(conf *Config) error {
	...
	if conf.OutputFile != "" {
		...
		name := conf.OutputFile[:len(conf.OutputFile)-len(ext)] + "-data" + ext
		var outData *os.File
		if outData, err = os.Create(name); err != nil {
			return err
		}
		if _, err := wData.WriteTo(outData); err != nil {
			return err
		}
